...
public class MainWindow extends javax.swing.JFrame {
    public MainWindow() {
		...
		SwingStyle.init();
		ArStyle.init();
		Style.registerCssClasses(jLabel1, ".label");
		Style.registerCssClasses(jLabel2, ".label");
		Style.registerCssClasses(jLabel3, ".label");
		Style.registerCssClasses(jLabel4, ".label");
		Style.registerCssClasses(rootPanel, "#rootPanel");
		Style.registerCssClasses(jPanel1, ".panel", "#panel1");
		Style.registerCssClasses(jPanel2, ".panel", "#panel2");
		Style.registerCssClasses(jPanel3, ".panel", "#panel3");
		Style.registerCssClasses(tabPanel, ".tabPanel");
		Style.apply(getContentPane(), new Style(getClass().getResource("style.css")));

		tabPanel.getModel().add(p1, "White panel", Res.getImage("gfx/ic_file.png"));
		tabPanel.getModel().add(p2, "Black panel", Res.getImage("gfx/ic_file.png"));
    }
